    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            محادثة مباشرة مع ولي أمر الطالب: زيد طارق (أ/ طارق المنصور)
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-[600px]">
        ...
        <div className="p-4 border-b border-slate-100 flex items-center gap-3 bg-slate-50/60">
          ...
          <div>
            <span className="font-bold text-slate-900 text-sm block">أ/ طارق المنصور (ولي أمر زيد)</span>
              ...
              >
                <div className="flex items-center gap-2 mb-1 text-[11px] text-slate-400">
                  <span className="font-bold text-slate-600">
                    {isTeacher ? "أنت (المعلم)" : "ولي الأمر (أ/ طارق)"}
                  </span>
                  <span>•</span>
