...
async function main() {
  ...
  // 6. Seed Plans (reduced by 35% for group, 50% for family, 55% for private)
  const plansData = [
    {
      type: PlanType.GROUP,
    ...
    },
    {
      ...
      priceMinorUnits: 6705, // $67.05 / month (was $149.00 - 55% off)
      interval: BillingInterval.MONTHLY,
    },
    {
      ...
      priceMinorUnits: 6450, // $64.50 / month (was $129.00 - 50% off)
      interval: BillingInterval.MONTHLY,
    },
  ];
